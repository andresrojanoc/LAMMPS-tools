...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(tersoff/mod/zbl,PairTersoffMODZBL);
// clang-format on
#else

#ifndef LMP_PAIR_TERSOFF_MOD_ZBL_H
#define LMP_PAIR_TERSOFF_MOD_ZBL_H
...
class PairTersoffMODZBL : public PairTersoffMOD {
 public:
  PairTersoffMODZBL(class LAMMPS *);

  static constexpr int NPARAMS_PER_LINE = 24;
